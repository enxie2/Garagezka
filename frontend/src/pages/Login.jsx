      ...
      <div className="relative w-full max-w-5xl bg-[#121212] border border-[#2A2A2A] rounded-3xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 shadow-2xl">
        ...
        <div className="hidden lg:flex flex-col justify-center p-14 bg-[#151515] relative overflow-hidden">
          ...
          <p className="text-gray-400 mt-6 leading-relaxed">
            Platform booking servis motor modern dengan pengalaman cepat,
        ...
        <div className="p-8 lg:p-14 flex flex-col justify-center">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-500 hover:bg-red-600 transition-all text-white py-4 rounded-2xl font-semibold shadow-lg shadow-red-500/20 disabled:opacity-60"
            >
